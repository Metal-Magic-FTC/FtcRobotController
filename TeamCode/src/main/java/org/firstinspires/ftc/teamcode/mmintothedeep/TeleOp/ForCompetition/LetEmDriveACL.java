...
@TeleOp(name="!!!!!!!!!!!!!!!! For others to drive and cop huzz frfr ong w rizz")
@Disabled
public class LetEmDriveACL extends LinearOpMode {
    ...
    public void moveRobot() {
        double y = -gamepad2.left_stick_y*0.5 - gamepad1.left_stick_y / 2; // REVERSED -gamepad1.left_stick_y.gamestick so
        ...
        double x = gamepad2.left_stick_x*0.5 + gamepad1.left_stick_x / 2; // gamepad1 can also do movement for hanging
        // making sure it doesnt go over 1 or -1
        if (x > 1) {
            x = 1;
        } else if (x < -1) {
        ...
        double rx = gamepad2.right_stick_x*0.5 + gamepad1.right_stick_x / 2; // gamepad1 can also do movement for hanging
        // making sure it doesnt go over 1 or -1
        if (rx > 1) {
            rx = 1;
        } else if (rx < -1) {
