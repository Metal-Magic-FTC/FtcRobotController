...
//    static final Pose2D BASKET_TARGET = new Pose2D(DistanceUnit.MM,-415,180,AngleUnit.DEGREES,46);
    ...
    //    static final Pose2D SAMPLE_1 = new Pose2D(DistanceUnit.MM,-302,450,AngleUnit.DEGREES,90);
    static final Pose2D SAMPLE_1 = new Pose2D(DistanceUnit.MM,-320,400,AngleUnit.DEGREES,90);

    //    static final Pose2D SAMPLE_2 = new Pose2D(DistanceUnit.MM,-522,450,AngleUnit.DEGREES,90);
    static final Pose2D SAMPLE_2 = new Pose2D(DistanceUnit.MM,-540,400,AngleUnit.DEGREES,90);

    //    static final Pose2D SAMPLE_3 = new Pose2D(DistanceUnit.MM,-515,570,AngleUnit.DEGREES,120);
    static final Pose2D SAMPLE_3 = new Pose2D(DistanceUnit.MM,-597,445,AngleUnit.DEGREES,109);

    static final Pose2D WAYPOINT_SUB = new Pose2D(DistanceUnit.MM,-340,1260,AngleUnit.DEGREES,0);

    static final Pose2D SUB = new Pose2D(DistanceUnit.MM,200,1325,AngleUnit.DEGREES,0);
...
//                        runToPosition(pivotMotor, UtilityValues.PIVOT_MOTOR_SUB, 0.4);
                ...
                case DRIVE_TO_TARGET_3:
                    if(nav.driveTo(odo.getPosition(), BASKET_TARGET, 0.625, 0.2)){
                ...
                case DRIVE_TO_TARGET_5:
                    if(nav.driveTo(odo.getPosition(), BASKET_TARGET, 0.60, 0.2)){
                        powerOff();
                        telemetry.addLine("at position #3");
                ...
                case DRIVE_TO_TARGET_10:
                    if(nav.driveTo(odo.getPosition(), BASKET_TARGET, 0.60, 0.4)) {
                        ...
                        if (timeElapsed5th(1800)) {
                            turnServo.setPosition(UtilityValues.TURN_POS_DOWN);
                            runToPosition(linearSlideMotor, (int) UtilityValues.SLIDE_POS_SAMP, 1);
                        } else if (timeElapsed5th(1300)) {
                            runToPosition(pivotMotor, UtilityValues.PIVOT_MOTOR_FLOAT, 0.2);
