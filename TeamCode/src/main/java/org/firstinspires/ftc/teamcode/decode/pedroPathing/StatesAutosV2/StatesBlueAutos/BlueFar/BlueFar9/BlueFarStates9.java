package org.firstinspires.ftc.teamcode.decode.pedroPathing.StatesAutosV2.StatesBlueAutos.BlueFar.BlueFar9;
...
//        wait(1500);
        ...
        runPathWithIntake(paths.toIntake1(), 0, 0.23);
        runPathWithIntake(paths.intakeball1(), 0, 0.23);
