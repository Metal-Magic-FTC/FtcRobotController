...
@Autonomous(name = "!!!!! V3 V3 V3 V3 Red Close Jan 10")
public class RedBackV3 extends LinearOpMode {
    ...
    private GeneratedPathsRedBackV3 paths;
    ...
    private boolean intakeRow = false;
