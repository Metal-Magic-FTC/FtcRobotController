...
@Disabled
@Autonomous(name = "!!!!! V4 V4 V4 V4 Red Close Jan 10")
public class RedBackV4 extends LinearOpMode {
    ...
    private GeneratedPathsRedBackV4 paths;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        follower.setPose(GeneratedPathsRedBackV4.START_POSE);
        paths = new GeneratedPathsRedBackV4(follower);
