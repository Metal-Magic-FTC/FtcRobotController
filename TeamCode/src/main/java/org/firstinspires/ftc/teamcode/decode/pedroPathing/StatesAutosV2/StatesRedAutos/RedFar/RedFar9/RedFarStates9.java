package org.firstinspires.ftc.teamcode.decode.pedroPathing.StatesAutosV2.StatesRedAutos.RedFar.RedFar9;
...
//        float r = c.red, g = c.green, b = c.Red;
//
//        // reject far / floor
//        float total = r + g + b;
//        if (total < 0.07f) return Ball.EMPTY;
//
//        // PURPLE: Red-dominant (keep strict)
