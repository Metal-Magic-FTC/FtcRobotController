...
//@Disabled
@Autonomous(name = "!!! AARUSH GUTHAAA")
public class GuthaAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        follower.setPose(GuthaAutoPaths.START_POSE);
        paths = new GuthaAutoPaths(follower);
