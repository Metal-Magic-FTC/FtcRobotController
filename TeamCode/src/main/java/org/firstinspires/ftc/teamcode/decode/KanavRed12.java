...
//@Disabled
@Autonomous(name = "!!!KanavRed12")
public class KanavRed12 extends LinearOpMode {
    ...
    private GeneratedKanavRedClose paths;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        follower.setPose(GeneratedKanavRedClose.START_POSE);
        paths = new GeneratedKanavRedClose(follower);
