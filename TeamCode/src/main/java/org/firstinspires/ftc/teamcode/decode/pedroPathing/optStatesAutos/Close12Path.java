...
public class Close12Path {
    private final Follower f;

    public Pose start = new Pose(30.25, 132.75, Math.toRadians(90));
    public Pose scorePControl = new Pose(56, 66);
    public Pose score = new Pose(48, 96, Math.toRadians(135)); // score
    public Pose intake1 = new Pose(17,83.5, Math.toRadians(180)); // intake\
    public Pose intake1Control = new Pose(70, 80);
    public Pose intake2 = new Pose(15, 60, Math.toRadians(180)); // intake
    public Pose intake2Control = new Pose(78, 53);
    public Pose gate = new Pose(16.25, 72.500, Math.toRadians(90)); //new Pose(144-132.781509, 61, Math.toRadians(28+90)); // gate
    public Pose gateControl = new Pose(55, 73); //62);
    public Pose intake3 = new Pose(12, 35, Math.toRadians(180));
    public Pose intake3Control = new Pose(65, 16);
    ...
    public Pose park = new Pose(48, 72, Math.toRadians(90));//new Pose(36, 12, Math.toRadians(180));

    private int index;

    public Close12Path(Follower f) {
        this.f = f;
